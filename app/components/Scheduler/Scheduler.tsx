...
//TODO make LUchat accept a prop in scheduler
//TODO make it so ai can support tools.
...
export default function Scheduler() {
  ...
  let events: CalendarEvent[] = []; //Maybe use code to check if there are clashes to use less tokens.
